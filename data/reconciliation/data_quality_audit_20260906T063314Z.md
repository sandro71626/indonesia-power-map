# Data Quality Audit — 2026-09-06T06:33:14.916060+00:00
...
| papua | sub | `RUPTL-PAPUA-GI-0001` | Holtekamp | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0008` | Angkasa | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0011` | Sentani Baru | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0015` | Manokwari | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0005` | Jeranjang | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0006` | Switching Mataram | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0009` | Tanjung | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0012` | Jeranjang | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0013` | Labuhan/ Sumbawa | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0001` | Naibonat | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0002` | Naibonat | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0003` | Bolok | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0013` | Kupang / Maulafa Baru | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0015` | Kefamenanu | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0016` | Atambua | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0023` | Labuan Bajo | 60.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
...
| maluku | sub | `RUPTL-MALUKU-GI-0001` | Kairatu | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| maluku | sub | `RUPTL-MALUKU-GI-0006` | Tidore | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| maluku | sub | `RUPTL-MALUKU-GI-0007` | Maba | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0007` | Wamena | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0014` | Keerom | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0017` | Prafi | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0004` | Empang | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0007` | Alas | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0008` | Taliwang | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0010` | Pringgabaya | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0011` | Sape | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0014` | Maluk | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntb | sub | `RUPTL-NTB-GI-0015` | New Lotim | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0004` | Ropa | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0006` | Waingapu | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0007` | PLTMG Waingapu | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0011` | Maumere | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0012` | Malaka | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0014` | Amfoang | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0017` | Atambua | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0019` | Larantuka | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0021` | Waitabula/ Tambolaka | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0022` | Waikabubak | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0024` | Ruteng | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0025` | Bajawa | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0026` | Kefamenanu | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0027` | Waingapu | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| ntt | sub | `RUPTL-NTT-GI-0028` | Nonohonis | 30.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
...
| maluku | sub | `RUPTL-MALUKU-GI-0003` | Mako | 20.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
...
| papua | sub | `RUPTL-PAPUA-GI-0002` | Elelim | 10.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0003` | Ilaga | 10.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0004` | Karubaga | 10.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0005` | Mulia | 10.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
| papua | sub | `RUPTL-PAPUA-GI-0006` | Sumohai | 10.0 | Action type kosong () | Check RUPTL PDF Lingkup column parsing |
...
_(+21 more, see per-region reports)_
...
_(+355 more, see per-region reports)_
...
| Region | Kind | ID | Name | MW/km | Reason | Action |
| --- | --- | --- | --- | ---: | --- | --- |
| jamali | gen | `(bulk)` | 260 planned generators fallback ke provi | — | Gazetteer match miss → coord = province centroid + jitter | Build additional gazetteer (BIG shapefile, PLN annual report |
| sumatra | gen | `(bulk)` | 228 planned generators fallback ke provi | — | Gazetteer match miss → coord = province centroid + jitter | Build additional gazetteer (BIG shapefile, PLN annual report |
| kalimantan | gen | `(bulk)` | 73 planned generators fallback ke provin | — | Gazetteer match miss → coord = province centroid + jitter | Build additional gazetteer (BIG shapefile, PLN annual report |
| sulawesi | gen | `(bulk)` | 56 planned generators fallback ke provin | — | Gazetteer match miss → coord = province centroid + jitter | Build additional gazetteer (BIG shapefile, PLN annual report |
| maluku | gen | `(bulk)` | 51 planned generators fallback ke provin | — | Gazetteer match miss → coord = province centroid + jitter | Build additional gazetteer (BIG shapefile, PLN annual report |
| papua | gen | `(bulk)` | 69 planned generators fallback ke provin | — | Gazetteer match miss → coord = province centroid + jitter | Build additional gazetteer (BIG shapefile, PLN annual report |
...
| ntt | gen | `(bulk)` | 48 planned generators fallback ke provin | — | Gazetteer match miss → coord = province centroid + jitter | Build additional gazetteer (BIG shapefile, PLN annual report |
