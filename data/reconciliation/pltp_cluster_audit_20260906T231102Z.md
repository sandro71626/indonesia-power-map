# PLTP / Unnamed Generator Cluster Audit — 2026-09-06T23:11:02.106794+00:00

Cluster radius: 3.0 km

## Summary

- Total generator features scanned: 643
- Unnamed features total: 21
- Unnamed PLTP/geothermal features: 18
- Candidate clusters (≥2 members): 15
- Features in some cluster: 63
- Unnamed features resolvable via CONFIDENT/PROBABLE cluster: 18
- Total PLTP capacity dataset: 3859.2 MW
- PLTP capacity inside clusters: 2775.0 MW
- Double-counting risk: 71.9% of PLTP capacity is in cluster candidates
...
### Cluster: **PLTP Kamojang** (jamali) — 10 features, 235.8 MW total
_1 named PLTP + 9 unnamed within 3.0km, same operator (['Indonesia Power;Pertamina Geothermal Energy'])_

| Feature ID | Name | Type | MW | Coord | Operator | OSM ID |
| --- | --- | --- | ---: | --- | --- | --- |
| `GEN-JMB-0001` | PLTP Kamojang | PLTP | 235.85 | -7.1398, 107.7858 | Indonesia Power;Pertamina Geot | `relation/7406922` |
| `GEN-JMB-0155` | (unnamed) | PLTP | — | -7.1552, 107.7704 |  | `way/1349227479` |
| `GEN-JMB-0156` | (unnamed) | PLTP | — | -7.1490, 107.7731 |  | `way/1349227480` |
| `GEN-JMB-0157` | (unnamed) | PLTP | — | -7.1389, 107.7954 |  | `way/1349709972` |
| `GEN-JMB-0158` | (unnamed) | PLTP | — | -7.1395, 107.7924 |  | `way/1349709973` |
| `GEN-JMB-0159` | (unnamed) | PLTP | — | -7.1514, 107.7963 |  | `way/1349718127` |
| `GEN-JMB-0160` | (unnamed) | PLTP | — | -7.1494, 107.8012 |  | `way/1349718128` |
| `GEN-JMB-0161` | (unnamed) | PLTP | — | -7.1453, 107.8018 |  | `way/1349718129` |
| `GEN-JMB-0162` | (unnamed) | PLTP | — | -7.1244, 107.8005 |  | `way/1349718130` |
| `GEN-JMB-0163` | (unnamed) | PLTP | — | -7.1314, 107.7999 |  | `way/1349718131` |

### Cluster: **PLTP Patuha** (jamali) — 3 features, 55.0 MW total
_1 named PLTP + 2 unnamed within 3.0km, same operator (['PT Geo Dipa Energi'])_

| Feature ID | Name | Type | MW | Coord | Operator | OSM ID |
| --- | --- | --- | ---: | --- | --- | --- |
| `GEN-JMB-0094` | PLTP Patuha | PLTP | 55.0 | -7.1840, 107.4226 | PT Geo Dipa Energi | `way/894351143` |
| `GEN-JMB-0177` | (unnamed) | PLTP | — | -7.1852, 107.4449 |  | `way/1376673992` |
| `GEN-JMB-0178` | (unnamed) | PLTP | — | -7.1716, 107.4191 |  | `way/1376687177` |


## PROBABLE_COMPLEX (2)

### Cluster: **PLTP Star Energy Darajat** (jamali) — 7 features, 280.2 MW total
_1 named PLTP + 5 unnamed, multiple operators: {'Indonesia Power', 'Star Energy Geothermal'}_

| Feature ID | Name | Type | MW | Coord | Operator | OSM ID |
| --- | --- | --- | ---: | --- | --- | --- |
| `GEN-JMB-0038` | PLTP Star Energy Darajat | PLTP | 225.17 | -7.2178, 107.7275 | Star Energy Geothermal | `way/271376029` |
| `GEN-JMB-0095` | PLTP Darajad | PLTP | 55.0 | -7.2156, 107.7379 | Indonesia Power | `way/894351144` |
| `GEN-JMB-0165` | (unnamed) | PLTP | — | -7.2311, 107.7327 |  | `way/1352369452` |
| `GEN-JMB-0166` | (unnamed) | PLTP | — | -7.2279, 107.7274 |  | `way/1352369453` |
| `GEN-JMB-0167` | (unnamed) | PLTP | — | -7.2248, 107.7184 |  | `way/1352369454` |
| `GEN-JMB-0168` | (unnamed) | PLTP | — | -7.2253, 107.7099 |  | `way/1352369455` |
| `GEN-JMB-0169` | (unnamed) | PLTP | — | -7.2315, 107.7164 |  | `way/1352369456` |

### Cluster: **PLTP Star Energy Salak** (jamali) — 4 features, 363.0 MW total
_1 named PLTP + 2 unnamed, multiple operators: {'Indonesia Power', 'Star Energy Geothermal'}_

| Feature ID | Name | Type | MW | Coord | Operator | OSM ID |
| --- | --- | --- | ---: | --- | --- | --- |
| `GEN-JMB-0018` | PLTP Star Energy Salak | PLTP | 183.0 | -6.7405, 106.6728 | Star Energy Geothermal | `way/166624588` |
| `GEN-JMB-0020` | (unnamed) | PLTP | — | -6.7364, 106.6696 |  | `way/167369571` |
| `GEN-JMB-0021` | (unnamed) | PLTP | — | -6.7458, 106.6414 |  | `way/167369572` |
| `GEN-JMB-0096` | PLTP Gunung Salak | PLTP | 180.0 | -6.7417, 106.6467 | Indonesia Power | `way/894351145` |
